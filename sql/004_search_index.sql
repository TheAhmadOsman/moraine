DROP VIEW IF EXISTS moraine.mv_search_documents_from_normalized;
DROP VIEW IF EXISTS moraine.mv_search_documents_from_compacted;
...
CREATE TABLE IF NOT EXISTS moraine.search_documents (
  doc_version UInt64,
...
CREATE TABLE IF NOT EXISTS moraine.search_postings (
  post_version UInt64,
  term String,
  doc_id String,
  session_id String,
...
CREATE TABLE IF NOT EXISTS moraine.search_query_log (
...
CREATE TABLE IF NOT EXISTS moraine.search_hit_log (
  ts DateTime64(3) DEFAULT now64(3),
  query_id String,
  rank UInt16,
  event_uid String,
